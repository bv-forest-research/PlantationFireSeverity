...
#Run it without basal area outliers in Nadina:
...
fwrite(RF_dat, "./Outputs/Tables/RF_ClassificationError.csv")
...
fwrite(TrainImp_dt, "./Outputs/Tables/RF_PartialScores.csv")
...
ggsave(filename = "Fig2o.jpg",path = "J:/Github/PlantationFireSeverity/Outputs/Figures/", device='jpeg', dpi=500, bg="white")
...
ggsave(filename = "Fig3o.jpg",path = "J:/Github/PlantationFireSeverity/Outputs/Figures/", device='jpeg', dpi=500, bg="white")
...
ggplot(TrainImp_dt, aes(x = PartialScore, y = reorder(VarNam,PartialScore))) +  
  ...
  facet_wrap("FireID")
ggsave(filename = "Fig1_supp.jpg",path = "./Outputs/Figures/", device='jpeg', dpi=300, bg="white")
ggsave(filename = "Fig1o_supp.jpg",path = "J:/Github/PlantationFireSeverity/Outputs/Figures/", device='jpeg', dpi=500, bg="white")
...
#From the data csvs
csvs_names <- list.files(path="../BVRCfire/Inputs/", pattern = "dat270.csv", full.names = TRUE)
...
ggplot(dat_csv_dt, aes(x=PlantAge, y=dNBRReSamp))+
  ...
  facet_wrap("FireID")+
#  theme(strip.text.x = element_text(face="bold"),text=element_text(size=15))
#ggsave(filename = "Fig2_supp.jpg",path = "./Outputs/Figures/", device='jpeg', dpi=1000, bg="white")
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        strip.background = element_blank(),strip.text.x = element_text(face="bold"), 
        text=element_text(size=21)) #for presentations

ggsave(filename = "Fig4_supp.jpg",
       path = "D:/Sync/BVRC/Fire program/communication/PlantationSeverity/",
       device='jpeg', dpi=500, bg="white")
ggsave(filename = "Fig4o_supp.jpg",path = "J:/Github/PlantationFireSeverity/Outputs/Figures/", device='jpeg', dpi=500, bg="white")

gamMod <- mgcv::gam(dNBRReSamp~s(PlantAge), data = dat_csv_dt[FireID=="Chutanli"], method = "REML")
summary(gamMod)
gamMod <- mgcv::gam(dNBRReSamp~s(PlantAge), data = dat_csv_dt[FireID=="Island"], method = "REML")
summary(gamMod)
gamMod <- mgcv::gam(dNBRReSamp~s(PlantAge), data = dat_csv_dt[FireID=="Nadina"], method = "REML")
summary(gamMod)
...
ggplot(dat_csv_dt[FireID=="Tezzeron"], aes(x=PlantAge, y=dNBRReSamp))+
